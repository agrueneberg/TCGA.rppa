            ...
            queue = async.queue(function (file, callback) {
             ...
             // Download individual files.
                TCGA.get(file, function (err, body) {
                    ...
                    var expressionLevels, sampleRef, compositeElementRef, group;
                 ...
                 // Check if the sample belongs to the control (1) or the experimental group (2).
                    if (file.indexOf(".Control_") !== -1) {
                        group = 1;
                    } else {
                        group = 2;
                    }
                 ...
                 // prevent potential errors. Unless of course, those values are missing.
                    Object.keys(expressionLevels).map(function (protein) {
                        data.push([sampleRef, compositeElementRef, protein, expressionLevels[protein], group]);
                    });
